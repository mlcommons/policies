...
Anytime up until the final human readable deadline, an entry may be withdrawn by amending the pull request. Alternatively, an entry may be voluntarily moved from the closed or network divisions to the open division. Submission withdrawals must be made in good faith, due to legitimate and unexpected competitive issues.
