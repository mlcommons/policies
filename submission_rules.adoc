...
Any use of published results in connection with the MLPerf trademark must follow the xref:MLPerf_Results_Messaging_Guidelines.adoc[MLPerf Results Messaging Guidelines].
