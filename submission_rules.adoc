...
********** ranging/
*********** mlperf_log_detail.txt # logs from raning run in power submission
*********** mlperf_log_summary.txt # logs from raning run in power submission
*********** spl.txt # logs from raning run in power submission
********** client.json
********** client.log
********** ptd_logs.txt
********** server.json
