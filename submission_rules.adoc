...
```
The directory structure for Inference could be automatically generated by following link:https://docs.mlcommons.org/inference/submission/#__tabbed_1_2[this] documentation.
