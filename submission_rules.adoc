...
| Friday | 12:30pm San Jose: Final results in human readable form due, opportunity to withdraw
|  | 1:00pm San Jose: Human readable results summary distributed by chair
| *Week 4* | *Publication*
