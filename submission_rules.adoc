...
```
The directory structure for Inference could be automatically generated by following [this](https://docs.mlcommons.org/inference/submission/#__tabbed_1_2) documentation.
