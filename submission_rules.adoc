...
| Preview | Must be available for rent or purchase in time for the next equivalent submission or within 180 days whichever is longer | Available except for software required to support substantially new hardware
