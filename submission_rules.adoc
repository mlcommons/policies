...
tie. In the case of a tie, the first non-submitter from the following list will
cast the deciding vote: the review chair, the chairs of the relevant working
group shortest tenure first, the chairs of the relevant power working group
shortest tenure first, and a random number generator.
