...
#### Joint submissions
For review assignments, treat each company involved in a joint submission as a separate organization. Joint submissions do not count as an extra submitting organization. For example, if Supermicro and Mangoboost submit together, both Supermicro and Mangoboost are considered as individual submitters. The joint submission is reviewed by two organizations (not just one).
