...
******** spl.txt # only needed for power submission
******* ranging/ # only needed for power submission
******** mlperf_log_detail.txt # logs from ranging run in power submission
******** mlperf_log_summary.txt # logs from ranging run in power submission
******** spl.txt # logs from ranging run in power submission
******* power/ # only needed for power submission
******** client.json
******** client.log
******** ptd_logs.txt
******** server.json
...
For power submission, the following files are also mandatory:

*   mlperf_log_summary.txt from ranging run
*   mlperf_log_detail.txt from ranging run
*   spl.txt from both ranging and testing runs
*   client.json
*   client.log
*   ptd_logs.txt
*   server.json
...
Note that in power submission run, the "mlperf_log_summary.txt" and "mlperf_log_detail.txt" from the testing run are put
right under "run_1/" to be compatible with submissions without power submission.
