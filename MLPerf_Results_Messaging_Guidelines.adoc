...
Specific to MLPerf Training, "retired" division results cannot be compared to any other MLPerf results. For example, a retired submission for Stable Diffusion v2 benchmark (v5.0 was the last round when the benchmark was in the suite) made during MLPerf Training round 6.0 cannot be compared to MLPerf results for Stable Diffusion v2 in say v4.1 because a submitter cannot claim victory over a competitor after it is retired.
