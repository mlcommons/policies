...
== Use of MLPerf® Client Application

If you have used the MLPerf Client Application for reproducing benchmark results of configurations that have been tested by MLCommons or of configurations that have not been tested by MLCommons, please do not use these Guidelines for messaging your results. Rather, please see the MLPerf Client Application End User License Agreement included with the Application.
