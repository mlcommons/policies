...
# I.	Use of MLPerf™ Benchmark for Non-MLCommons Reviewed Results
...
# II.	Use of MLPerf™ Benchmark for MLCommons Reviewed and Verified Results
...
# III.	MLPerf™ Benchmark results must clearly identify basic details in the main text, table, or figure
...
# IV.	MLPerf results may only be compared against similar MLPerf results
...
# V.	When comparing MLPerf results, you must identify any submission differences
...
>**Required Footnote**: “[1]Result not verified by MLCommons Association. MLPerf™ name and logo are trademarks of MLCommons Association in the United States and other countries. All rights reserved. Unauthorized use strictly prohibited. See [www.mlcommons.org](www.mlcommons.org) for more information.
...
>**Required Footnote**: “[1]Result verified by MLCommons Association. MLPerf™ name and logo are trademarks of MLCommons Association in the United States and other countries. All rights reserved. Unauthorized use strictly prohibited. See [www.mlcommons.org](www.mlcommons.org) for more information.”
...
# VI.	When comparing MLPerf Results, use official MLPerf power metrics
...
>**Required Footnote 2**: “[2]Result verified by MLCommons Association. MLPerf™ name and logo are trademarks of MLCommons Association in the United States and other countries. All rights reserved. Unauthorized use strictly prohibited. See [www.mlcommons.org](www.mlcommons.org) for more information.”
...
# VII.	Timing for Results Disclosures 
...
# VIII.	MLCommons allows but does not endorse combining results of benchmarks
...
# IX.	Comparisons based on secondary or derived metrics must be explicit 
...
# X.	Statements Must be Clear and Correct; No Misrepresentation as to Meaning.
...
# XI.	Additional Requirements and Restrictions
  ...
  ## d. Use with Full Benchmark Name
  ...
  ##	e. No Use in Company or Product Names
...
5. Continued failure to conform to these Guidelines by a violator may lead to marking the results as non-compliant in the results database permanently.
  ...
  # XIII.	DISCLAIMER; LIMITATION OF LIABILITY
  ...
  If you have any questions regarding these Guidelines, please contact MLCommons at [trademark@mlcommons.org](trademark@mlcommons.org). 
