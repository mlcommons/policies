...
Specific to MLPerf Training, "retired" division results cannot be compared to any other past MLPerf results. For example, a retired submission for Stable Diffusion v2 benchmark (retired in round v5.0) in MLPerf Training round 6.0 cannot be compared to MLPerf results for Stable Diffusion v2 in v4.1 because a submitter cannot claim victory over a competitor years after the competitor stopped submitting to the benchmark as it was retired.
